...
namespace CooQ.Column
{
  ...
  /// 
  /// </summary>
  public class NDateTime2Column : ColumnBase
  {
    ...
    public NDateTime2Column(TableBase table, string columnName)
      : base(table, columnName, false)
    {
    }

    public NDateTime2Column(TableBase table, string columnName, bool isPrimaryKey)
      : base(table, columnName, isPrimaryKey)
    {
    }

    public static Condition operator ==(NDateTime2Column columnA, DateTime2Column columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NDateTime2Column columnA, NDateTime2Column columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NDateTime2Column columnA, DateTime value)
    {
