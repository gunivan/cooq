...
namespace CooQ.Column
{
  ...
  /// 
  /// </summary>
  public class DateTime2Column : ColumnBase
  {
    ...
    public DateTime2Column(TableBase table, string columnName)
      : base(table, columnName, false)
    {
    }

    public DateTime2Column(TableBase table, string columnName, bool isPrimaryKey)
      : base(table, columnName, isPrimaryKey)
    {
    }

    public static Condition operator ==(DateTime2Column columnA, DateTime2Column columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(DateTime2Column columnA, NDateTime2Column columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(DateTime2Column columnA, DateTime value)
    {
