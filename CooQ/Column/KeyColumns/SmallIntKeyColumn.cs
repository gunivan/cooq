...
{
  public class SmallIntegerKeyColumn<TABLE> : NumericColumnBase where TABLE : TableBase
  {
    ...
    public SmallIntegerKeyColumn(TableBase table, string columnName)
      : base(table, columnName, false)
    {
    }

    public SmallIntegerKeyColumn(TableBase table, string columnName, bool isPrimaryKey)
      : base(table, columnName, isPrimaryKey)
    {
    }

    public SmallIntegerKeyColumn(TableBase table, string columnName, bool isPrimaryKey, bool isAutoId)
      : base(table, columnName, isPrimaryKey)
    {
      this.IsAutoId = isAutoId;
    }

    public static Condition operator ==(SmallIntegerKeyColumn<TABLE> columnA, SmallIntegerKeyColumn<TABLE> columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(SmallIntegerKeyColumn<TABLE> columnA, NSmallIntegerKeyColumn<TABLE> columnB)
    {
      return (Condition) new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(SmallIntegerKeyColumn<TABLE> columnA, short value)
    {
    ...
    public static NumericCondition<SmallIntegerKeyColumn<TABLE>, NSmallIntegerKeyColumn<TABLE>, short> operator +(SmallIntegerKeyColumn<TABLE> columnA, SmallIntegerKeyColumn<TABLE> columnB)
    {
    ...
    public static NumericCondition<SmallIntegerKeyColumn<TABLE>, NSmallIntegerKeyColumn<TABLE>, short> operator +(SmallIntegerKeyColumn<TABLE> columnA, NSmallIntegerKeyColumn<TABLE> columnB)
    {
      return new NumericCondition<SmallIntegerKeyColumn<TABLE>, NSmallIntegerKeyColumn<TABLE>, short>(columnA, NumericOperator.ADD, columnB);
    }

    public static NumericCondition<SmallIntegerKeyColumn<TABLE>, NSmallIntegerKeyColumn<TABLE>, short> operator +(SmallIntegerKeyColumn<TABLE> columnA, short value)
    {
