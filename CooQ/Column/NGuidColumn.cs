...
{
  public class NGuidColumn : ColumnBase
  {
    ...
    public NGuidColumn(TableBase table, string columnName)
      : base(table, columnName, false)
    {
    }

    public NGuidColumn(TableBase table, string columnName, bool isPrimaryKey)
      : base(table, columnName, isPrimaryKey)
    {
    }

    public static Condition operator ==(NGuidColumn columnA, GuidColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NGuidColumn columnA, NGuidColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NGuidColumn columnA, Guid value)
    {
