...
{
  public class NByteColumn : ColumnBase
  {
    ...
    public NByteColumn(TableBase table, string columnName, bool isPrimaryKey)
      : base(table, columnName, isPrimaryKey)
    {
    }

    public static Condition operator ==(NByteColumn columnA, NByteColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NByteColumn columnA, ByteColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NByteColumn columnA, byte value)
    {
    ...
    public byte ValueOf(Record record)
    {
      ...
      return null == obj ? byte.MinValue : (byte)obj;
    }
