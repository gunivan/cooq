...
{
  public class NSmallIntegerColumn : NumericColumnBase
  {
    ...
    public static Condition operator ==(NSmallIntegerColumn columnA, NSmallIntegerColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NSmallIntegerColumn columnA, SmallIntegerColumn columnB)
    {
      return (Condition)new ColumnCondition(columnA, Operator.EQUALS, columnB);
    }

    public static Condition operator ==(NSmallIntegerColumn columnA, short value)
    {
    ...
    public static NumericCondition<SmallIntegerColumn, NSmallIntegerColumn, short> operator +(NSmallIntegerColumn columnA, NSmallIntegerColumn columnB)
    {
      return new NumericCondition<SmallIntegerColumn, NSmallIntegerColumn, short>(columnA, NumericOperator.ADD, columnB);
    }

    public static NumericCondition<SmallIntegerColumn, NSmallIntegerColumn, short> operator +(NSmallIntegerColumn columnA, SmallIntegerColumn columnB)
    {
      return new NumericCondition<SmallIntegerColumn, NSmallIntegerColumn, short>(columnA, NumericOperator.ADD, columnB);
    }

    public static NumericCondition<SmallIntegerColumn, NSmallIntegerColumn, short> operator +(NSmallIntegerColumn columnA, short value)
    {
